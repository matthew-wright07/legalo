...
export default function DropDown(){
    ...
    return (
        <li className="flex justify-center items-center gap-1 group">
            ...
            <div className={`shadow-md border border-top px-24 py-8 grid grid-cols-2 lg:grid-cols-4 grid-rows-2 w-10 bg-white absolute top-28 left-0 w-full justify-center items-center gap-4 ${clicked?"block":"hidden"}`}>
