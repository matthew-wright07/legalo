export default function Intro(){
    return (
        ...
        <div className="py-4 flex flex-col gap-4 lg:w-1/3 w-full">
            ...
            <a href="/signUp" className="h-12 w-32 bg-primary text-white flex justify-center items-center rounded-lg hover:bg-hover">Start</a>
