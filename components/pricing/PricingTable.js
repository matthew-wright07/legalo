export default function PricingTable(){
    ...
    <div className="flex flex-col py-20 gap-6">
        <h1 className="text-center text-3xl font-bold text-black">Pricing</h1>
        <p className="w-1/3 text-center self-center">Get professional legal documents at a fraction of the cost of hiring a lawyer. With flexible subscription options, you only pay for what you need, no hidden fees, just simple and reliable pricing.</p>
